...
public class GetShortFormService implements GetShortFormUseCase {
    ...
    public ShortFormResult getShortForm(GetShortFormQuery query) {
        ...
        return toResult(shortForm, creatorNicknameQueryPort.getCreatorNickname(shortForm.getCreatorId()));
    }

    static ShortFormResult toResult(ShortForm shortForm, String creatorNickname) {
